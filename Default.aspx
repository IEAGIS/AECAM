<%@ Page Title="" Language="C#" MasterPageFile="~/DHS.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" %>
  ...
  <tr>
    <td>
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tbody>
              <tr>
                <td valign="top" colspan="2"><img src="Content/images/spacer.gif" width="20" height="25" /></td>
              </tr>
              <tr>
                <td valign="top">
                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                      <tbody>
                        <tr>
                          <td class="text_title">Welcome to Arkansas Early Childhood Asset Map<br /></td>
                        </tr>
                        <tr>
                          <td><img src="Content/images/bg_shadow.jpg" width="678" height="28" /></td>
                        </tr>
                        <tr>
						    <td>
						        <p class="text_main">The Arkansas Early Childhood Asset Map (AECAM) provides a variety of information on early childhood services in Arkansas. AECAM is composed of mapping services, a resource guide, and data from the <em>Getting Ready for School</em> publication.</p>
                                ...
                                <div class="bts">
                                  <ul class="bts">
                                    <li class="bts"><a target="_blank" title="Getting Ready for School 2007" class="tooltip" href="Content/grfs/Getting Ready For School 2007.pdf"><img src="Content/images/grfs2007.png" /></a></li>
                                    <li class="bts"><a target="_blank" title="Getting Ready for School 2008" class="tooltip"  href="Content/grfs/Getting Ready For School 2008.pdf"><img src="Content/images/grfs2008.png" /></a></li>
					    ...
					    <tr>
						    <td>
							    <p class="text_main">AECAM is a project of the <a target="_blank" href="http://www.arkansas.gov/childcare/">Arkansas Department of Human Services, Division of Child Care and Early Childhood Education</a> that is operated by the <a target="_blank" href="http://iea.ualr.edu">Institute for Economic Advancement</a> at the <a target="_blank" href="http://ualr.edu">University of Arkansas at Little Rock</a>.</p>
						    </td>
					    </tr>
                      </tbody>
                    </table>
                </td>
                <td valign="top" width="340" align="left">
					<img alt="girl_world" class="outline" src="Content/images/pix_Girl01.jpg" width="289" height="222" />
				</td>
              </tr>
              <tr>
                <td valign="top" colspan="2"><img alt="" src="Content/images/spacer.gif" width="20" height="25" /></td>
              </tr>
            </tbody>
          </table>
    </td>
